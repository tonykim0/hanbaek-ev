    ...
    '준공서류 접수/검토': [
      {
        ...
        docs: [
          ...
          'asBuilt',
          /*
           * ★전기안전점검수수료 영수증 — 준공 「뒤에」 오는 서류다★ (한백 2026-09-06
           * 「영수증도 협력사쪽에서 업로드하게 해줘. 공정과정에서」). 그래서 이 상자에
           * 자리는 있지만 ★완료 선언의 조건은 아니다★ — lib/process 의 COMPLETION_DOCS 에
           * 넣지 않았다. 넣으면 영수증이 없어 준공을 못 끝내고, 준공을 못 끝내서 영수증이
           * 안 오는 교착이 된다(옛 「준공서류」 한 칸이 그 꼴이었다).
