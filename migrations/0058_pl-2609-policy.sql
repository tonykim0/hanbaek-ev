-- 플러그링크 2026년 9월 1일 정책 — 보조금 +50만(마진 30만) · 연동 120/140만 (한백 지시 2026-09-06)
...
· 1개 단지 최대 130대(7년) / 120대(10년)', null, null, '· 기존 플러그링크 설치 현장 추가 영업 시 프로모션 없음(프로모션 기간만큼 계약 연장 합의서 작성 시 적용 가능)
