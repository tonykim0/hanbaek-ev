...
--
-- ★번호가 0064 에서 0065 로 밀렸다★ — 다른 세션이 같은 번호(0064_safety-fee-receipts)를
-- 먼저 넣어 러너가 빌드를 거부했다(2026-08-24 가드). DB 에 손대기 전에 막아서 사고는
-- 없었다. 새 번호는 원장이 아니라 디렉터리의 최대 번호 + 1 로 잡는다.
--
