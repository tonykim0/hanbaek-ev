...
/*
 * 기간 문장은 0071 이 덧붙였다(한백 2026-09-10 「기존 7/20 정책은 7/20~8/31 로」) — 9/1 부터는
 * sk-2609 연동 케이스(220/230)가 받는다. 0010 은 기간 없이 찍었고 이 상수는 지금 DB 값이다.
 */
const SK_LINK_INSTALL =
  '모자분리 조건 · 7년 계약 이상 · 지역: 수도권 · 6개 광역시 · 시 단위의 상면 · 적용: 2026-07-20 ~ 08-31 계약일 기준(접수된 설치 계약서의 계약일)';
/*
